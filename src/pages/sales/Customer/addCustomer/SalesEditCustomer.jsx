    ...
    return (
        <div className="mx-auto">
            <div className="bg-white p-4 rounded-xl shadow-md">
                ...
                {activeSection === "OtherDetails" && <SalesOtherDetails />}
                {activeSection === "Address" && <SalesAddress />}
                {activeSection === "Remarks" && <SalesRemarks />}
                {activeSection === "ContactPersons" && <SalesContactPersons />}
            </div>
...
export default SalesEditCustomer;
