...
const SalesAddInvoice = () => {
  ...
  const handleAddProduct = () => {
    ...
    const { product, product_SellingPrice, quantity, product_Discount } =
      currentProduct;
    ...
    <div className="max-w-4xl mx-auto p-8 bg-white rounded-lg shadow-lg">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              ...
              },
              {
                ...
                icon: <LocationMarkerIcon className="w-5 h-5 text-gray-500" />,
              },
            ].map(({ name, label, icon }) => (
        ...
        <section className="p-6 border border-gray-300 rounded-md bg-gray-50">
          ...
          {productError && (
            <p className="text-xs text-red-500 mt-2">{productError}</p>
          )}
